...
class Board {
	...
	//moved on, I could always switch the debug print statements back on to see
...
public:
	 ...
	 * the hard)
	 *
	 * So that's the walls.  Then I added the 'D' to the beginning square and an 'E' to the end square.
	 *
	 *
	 */
	void printBoard();
...
/* Note: Debug Mode:
	 ...
	 * responds "yes", then the wall is knocked down, the dog moves into that square, and the dog's
